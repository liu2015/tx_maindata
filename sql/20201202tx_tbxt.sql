...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RuoyiScheduler', 'liu1606900097664', 1606900115418, 15000);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1606900100000, -1, 5, 'PAUSED', 'CRON', 1606900097000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1606900110000, -1, 5, 'PAUSED', 'CRON', 1606900097000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1606900100000, -1, 5, 'PAUSED', 'CRON', 1606900097000, 0, NULL, 2, '');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COMMENT='代码生成业务表';
...
) ENGINE=InnoDB AUTO_INCREMENT=327 DEFAULT CHARSET=utf8mb4 COMMENT='代码生成业务表字段';
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_appmanid` VALUES (1, 'token', 'wwaa46bcce7b1f388a', NULL, NULL, NULL, NULL, 'q7OgmArKfeOKO_m6zFZX1FIDa-jCopS0MXaVMzrVhNM', '5yo2xfTSep15Rh18OyXn2_YuBeG1X9wUL_0BeCpTmI4QpUh4FSCFroFCYFvCQ5l35bMbZY6a3rdPk_0KgnbYsBMIz9i_G9_V0tlLFEhYA47F2LR5i46KneSqlV2jpEIqNss3FkXKEJHefgVlZ0nP_u_hcJzW-AbYJfTstRfDNn3Ikjb8dHmZ_09JAwH9OOOAaAOKEWD89zVqQE8TKMUdlA', 'https://qyapi.weixin.qq.com/cgi-bin/gettoken', 'wwaa46bcce7b1f388a', NULL, NULL);
COMMIT;
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2143 DEFAULT CHARSET=utf8mb4 COMMENT='菜单权限表';
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=439 DEFAULT CHARSET=utf8mb4 COMMENT='操作日志记录';
