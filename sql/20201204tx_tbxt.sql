...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RuoyiScheduler', 'liu1607065094303', 1607066312817, 15000);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1607065100000, -1, 5, 'PAUSED', 'CRON', 1607065094000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1607065095000, -1, 5, 'PAUSED', 'CRON', 1607065094000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1607065100000, -1, 5, 'PAUSED', 'CRON', 1607065094000, 0, NULL, 2, '');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=493 DEFAULT CHARSET=utf8mb4 COMMENT='代码生成业务表字段';
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_appmanid` VALUES (1, 'token', 'wwaa46bcce7b1f388a', NULL, NULL, NULL, NULL, 'q7OgmArKfeOKO_m6zFZX1FIDa-jCopS0MXaVMzrVhNM', 'hEoheyb6SV6Uwwobeg1Bvmqw3lk0jSM-QdXiIL8QYcM3lRqmdHPMqHuH1SSBoGEzgME87x34AHrEsPUmABE9Dbr8ky6P-vDEBgEDMtoZr5iOOhgdzn-XxH-59WkizI1O6qUFHbHxclWYfsxQJaJ2_nF1bGak4sCjtTq7H3EKka6qEndazhi0pgqlBuLkOnTkpIch2E4x8NW5BZzIiUNq3Q', 'https://qyapi.weixin.qq.com/cgi-bin/gettoken', 'wwaa46bcce7b1f388a', NULL, NULL);
COMMIT;
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2161 DEFAULT CHARSET=utf8mb4 COMMENT='菜单权限表';
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=475 DEFAULT CHARSET=utf8mb4 COMMENT='操作日志记录';
