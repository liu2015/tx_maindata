...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RuoyiScheduler', 'liuos-System1606831662394', 1606837246182, 15000);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1606831670000, -1, 5, 'PAUSED', 'CRON', 1606831662000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1606831665000, -1, 5, 'PAUSED', 'CRON', 1606831662000, 0, NULL, 2, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1606831680000, -1, 5, 'PAUSED', 'CRON', 1606831662000, 0, NULL, 2, '');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COMMENT='代码生成业务表';
...
) ENGINE=InnoDB AUTO_INCREMENT=290 DEFAULT CHARSET=utf8mb4 COMMENT='代码生成业务表字段';
...
CREATE TABLE `sys_appmanid` (
  ...
  `access_token` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'token',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_appmanid` VALUES (1, 'token', 'wwaa46bcce7b1f388a', NULL, NULL, NULL, NULL, 'q7OgmArKfeOKO_m6zFZX1FIDa-jCopS0MXaVMzrVhNM', NULL, 'https://qyapi.weixin.qq.com/cgi-bin/gettoken', NULL, NULL, NULL);
COMMIT;
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=145 DEFAULT CHARSET=utf8mb4 COMMENT='系统访问记录';
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2137 DEFAULT CHARSET=utf8mb4 COMMENT='菜单权限表';
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=337 DEFAULT CHARSET=utf8mb4 COMMENT='操作日志记录';
